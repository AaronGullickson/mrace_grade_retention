...
```{r marg-fit-table}
#| label: tbl-marg-fit
#| tbl-cap: Marginal probabilities of grade retention by racial group across models using different specifications to model the the temporal trend in grade retention by current grade of the student.
marg_prob_alt %>%
