...
the cross-tabulation of parent's races leads to ten distinct biracial categories that respondents may fall into. The total sample size for each of these biracial categories is shown in @fig-sample-size. The sample sizes are quite large for many of the groups, suggesting substantial statistical power in determining the relative outcomes for these groups. Even among the smallest group of Indigenous/Asian, the sample size is substantially greater than one would see in typical survey data ($n=519$).
