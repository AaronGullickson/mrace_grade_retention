...
@tbl-descriptive shows the percent of each racial group that is clearly behind the expected grade level. My goal is understand the level of grade retention for each biracial group relative to its constituent monoracial groups (e.g. a Black/White student compared to White and Black students). Throughout this article, I use a visual approach to illustrate this placement.

As an example, I display the percent of students clearly behind grade for White, Black, and Black/White students in @fig-example. The point estimate and confidence interval for the Black/White group is shown in red, while the two monoracial groups are shown via grey dots and confidence bands. For all three cases, I use 83.4% confidence intervals, because overlap on such intervals indicates that the observed difference between the two measures in the sample is not statistically distinguishable from zero in the population at $p<.05$ (CITE).[^2] In this case, the lack of overlap between the Black/White probability and either the White or Black band indicates that the Black/White probability of clearly being behind grade level is statistically distinguishable from both monoracial probabilities.

[^2]: While 95% confidence intervals are more common in practice, the overlap of such intervals does not necessarily indicate a lack of statistical significance
...
Additionally, I include a measure of the "halfway" point between the two racial groups.[^3] This halfway point allows me to determine where the biracial group falls relative to the expecation of being halfway between the two constituent monoracial groups. In this case, Black/White students are much closer to White students in their risk of grade retention, and have grade retention rates much lower than both Black students and the halfway expectation.
