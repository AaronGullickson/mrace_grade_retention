...
#TODO: It won't let me add strata - gives some error. This sucks because 
#strata may help to reduce SEs
design_matrix <- svydesign(ids=~cluster, weights=~perwt, data=design_matrix)
