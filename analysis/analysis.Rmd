...
spk_eng <- model.matrix(~spk_eng+spk_eng_father+spk_eng_mother, acs)[,-1]
#mean center
spk_eng <- t(t(spk_eng)-apply(spk_eng, 2, mean))
spk_eng <- as.data.frame(spk_eng)

design_matrix <- cbind(states, years, grades, metro, degree, spk_eng)
...
model2 <- update(model1, .~.+foreign_born+foreign_born_mother+
                   foreign_born_father+spk_engSomewhat+spk_engYes+
                   spk_eng_motherSomewhat+spk_eng_motherYes+
                   spk_eng_fatherSomewhat+spk_eng_fatherYes)
...
df_pred <- data.frame(race=levels(acs$race),
                      ...
                      spk_engSomewhat=0, spk_engYes=0, spk_eng_fatherSomewhat=0, 
                      spk_eng_fatherYes=0, spk_eng_motherSomewhat=0, spk_engYes=0,
