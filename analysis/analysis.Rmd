...
Now, I can run the models. Warning, the code chunks below take a bit of time to run!
...
$$\frac{\sqrt{s_1^2+s_2^2}}{2}$$
where $s_1$ is the standard error for monoracial group 1 and $s_2$ is the standard error for monoracial group 2. This formula follows from the standard formulas for the variance of the sum of random variables. 
...
g <- coef_table %>%
  ...
  labs(x=NULL,
       ...
       title="Probability of being behind grade for biracial black/white respondents and\nmonoracial comparison groups",
       caption="Non-overlap in confidence bands indicates statistically significant difference at the 5% level")

g+annotate("text", 1, 0.037, hjust="left",
             label="Grey bands give 83%\nconfidence interval around\nmonoracial estimates")+
  annotate("text", 2, 0.0475, hjust="left",
             label="Red band gives 83%\nconfidence interval around\nmidpoint estimate")+
  annotate("text", 2.5, 0.038, hjust="left",
...
ggplot(coef_table, aes(x=term, y=estimate, color=multiracial,
  ...
  labs(x=NULL,
       y="predicted probability of being behind expected grade",
       title="Probability of being behind grade for biracial respondents and\nmonoracial comparison groups",
       caption="Non-overlap in confidence bands indicates statistically significant difference at the 5% level")
```
