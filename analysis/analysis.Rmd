...
coef_table_mod0 <- calculate_cond_means(model0)
```
...
coef_table_mod4 <- calculate_cond_means(model4)
...
coef_table_mod1 <- calculate_cond_means(model1)
coef_table_mod2 <- calculate_cond_means(model2)
